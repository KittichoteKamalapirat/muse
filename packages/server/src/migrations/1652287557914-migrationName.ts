...
export class migrationName1652287557914 implements MigrationInterface {
    name = 'migrationName1652287557914'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "cart_item_noti" DROP COLUMN "creatorId"
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "cart_item_noti" DROP COLUMN "userId"
        `);
        await queryRunner.query(`
