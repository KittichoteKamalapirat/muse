...
export class migrationName1652353788663 implements MigrationInterface {
    name = 'migrationName1652353788663'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "mealkit_file"
                RENAME COLUMN "updatedAtt" TO "updatedAt"
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "mealkit_file"
                RENAME COLUMN "updatedAt" TO "updatedAtt"
        `);
        await queryRunner.query(`
            ALTER TABLE "video"
            ADD CONSTRAINT "FK_a38d033e82b1b0b0e6f7de67aad" FOREIGN KEY ("postId") REFERENCES "post"("id") ON DELETE CASCADE ON UPDATE NO ACTION
