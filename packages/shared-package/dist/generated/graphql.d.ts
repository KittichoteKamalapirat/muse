...
export declare type ReadOrderNotisMutationFn = Apollo.MutationFunction<ReadOrderNotisMutation, ReadOrderNotisMutationVariables>;
/**
 ...
 * });
 */
export declare function useReadOrderNotisMutation(baseOptions?: Apollo.MutationHookOptions<ReadOrderNotisMutation, ReadOrderNotisMutationVariables>): Apollo.MutationTuple<ReadOrderNotisMutation, Exact<{
    [key: string]: never;
}>, Apollo.DefaultContext, Apollo.ApolloCache<any>>;
export declare type ReadOrderNotisMutationHookResult = ReturnType<typeof useReadOrderNotisMutation>;
export declare type ReadOrderNotisMutationResult = Apollo.MutationResult<ReadOrderNotisMutation>;
export declare type ReadOrderNotisMutationOptions = Apollo.BaseMutationOptions<ReadOrderNotisMutation, ReadOrderNotisMutationVariables>;
 ...
 * });
 */
export declare function useOrderNotisQuery(baseOptions?: Apollo.QueryHookOptions<OrderNotisQuery, OrderNotisQueryVariables>): Apollo.QueryResult<OrderNotisQuery, Exact<{
    [key: string]: never;
}>>;
export declare function useOrderNotisLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<OrderNotisQuery, OrderNotisQueryVariables>): Apollo.QueryTuple<OrderNotisQuery, Exact<{
    [key: string]: never;
}>>;
export declare type OrderNotisQueryHookResult = ReturnType<typeof useOrderNotisQuery>;
export declare type OrderNotisLazyQueryHookResult = ReturnType<typeof useOrderNotisLazyQuery>;
export declare type OrderNotisQueryResult = Apollo.QueryResult<OrderNotisQuery, OrderNotisQueryVariables>;
