...
import { Img, Link, Image } from "@chakra-ui/react";
  ...
  return (
    <Box>
      <Box
        ...
        width="100%"
      >
        <Flex justifyContent="space-between" color="white" maxWidth="1000px">
          <NextLink href="/">
            <Link
          ...
          <Flex>
            {" "}
            <NextLink href="/">
              <Link style={{ textDecoration: "none" }} mr={2}>
                {/* <Text>About</Text> */}
              </Link>
            </NextLink>
            <NextLink href="/login">
      ...
      <Box mt={10} bgColor="gray.50" p={4}>
        ...
        <Wrapper>
          <Heading fontSize="xl">
            ...
            Anyone can be the recipe's creators
          </Heading>
