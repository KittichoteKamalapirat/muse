...
function SvgToPay(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <g id="ToPay_svg__Layer_2" data-name="Layer 2">
        <g id="ToPay_svg__Layer_1-2" data-name="Layer 1">
          <circle cx={48} cy={33} r={1} fill="#fc6" />
          <path
            className="ToPay_svg__cls-2"
            d="M50.7 11L47 1 19.5 11M57 39v13a3 3 0 01-3 3H4a3 3 0 01-3-3V14a3 3 0 013-3h50a3 3 0 013 3v13"
          />
          <rect
            className="ToPay_svg__cls-2"
            x={41}
