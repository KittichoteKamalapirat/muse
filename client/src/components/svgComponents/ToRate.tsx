...
function SvgToRate(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <g id="ToRate_svg__Layer_2" data-name="Layer 2">
        <g id="ToRate_svg__Layer_1-2" data-name="Layer 1">
          ...
          <path
            className="ToRate_svg__cls-1"
            d="M28.44 36.78l-10.28 6 2.42-11.49-8.46-7.86 11.48-1.16 4.84-10.88 4.84 10.88 11.48 1.21-8.46 7.86 2.42 11.49z"
          />
        </g>
      </g>
    </svg>
